...
import data from '../../../utilis/empires.json';
...
const Map = () => {
    ...
    const colors =  [
      ...
      useEffect(() => {
        // Helper to convert year based on era
        const normalizeYear = (year, era) => (era === "BC" ? -year : year);
      
        // Process empires
        data.forEach((empire, index) => {
          const start = normalizeYear(empire.time_period[0][0], empire.time_period[0][1]);
          const end = normalizeYear(empire.time_period[1][0], empire.time_period[1][1]);
      
          // Check if the given time is in the empire's range
          const isActive = time >= start && time <= end;
      
          empire.countries.forEach((country) => {
            // Select country elements in one go
            const elements = document.querySelectorAll(`.${country}`);
            elements.forEach((element) => {
              // Set the fill color based on the active status
              element.style.fill = isActive ? colors[index % colors.length] : "#ececec";
              isActive ? element.setAttribute("empire", `${empire.empire}`) : element.removeAttribute("empire");            
            });
          });
      
          // Update empire name only if active
          if (isActive) {
            document.getElementById("namep").innerHTML = empire.empire;
    ...
    document.querySelectorAll(".allPaths").forEach((e) => {
        ...
        e.addEventListener("mouseover", function () {
          ...
          if (tooltip) {
            ...
            if (e.getAttribute("empire")) {
              tooltip.style.top = e.clientY - 60 + "px";
              tooltip.style.left = e.clientX + 10 + "px";
              document.getElementById("namep").innerText = e.getAttribute("empire");
            }
          }
      
          // Cleanup mousemove listener on mouseleave
    ...
    <div class="map">
            ...
            <path class="allPaths" d="M1050.3 487.3l0 7.7-8.2 0-1.9 0.3-1.1-0.9 1.9-7.2 9.3 0.1z"   
            ...
            <path class="allPaths" d="M1247.5 309.4l1.5 2.8-0.3 1.5 2.4 4.8-3.9 0.2-1.7-3.1-5-0.6 3.3-6.2 3.7 0.6z"   
                id="Kuwait">
            </path>
            <path class="allPaths"
            ...
            <path class="allPaths" d="M1016.9 185.4l-1.4 0.1-1.1-0.5 0.4-3.5 1.3-0.2 1 1.4-0.2 2.7z"    id="Luxembourg">
            </path>
            <path class="allPaths"
            ...
            <path class="allPaths" d="M1178.3 293.8l0.4 4-0.6 1.9-2.5 0.8 0.1-1.7 1.3-0.9-1.5-0.7 0.7-4.2 2.1 0.8z"   
                id="Palestine">
            </path>
            <path class="allPaths" d="M1270.1 343.7l-1.5 0.5-1.8-1.3-0.8-4.7 1.1-3.3 1.5-0.7 1.8 2 0.5 3.7-0.8 3.8z"   
                id="Qatar">
            </path>
            <path class="allPaths"
            ...
            <path class="allPaths" d="M1657.9 355.5l-1.4 5.3-4-5.5-1.5-4.7 1.9-6.3 3.3-4.9 3 1.9-0.1 3.9-1.2 10.3z"   
                id="Taiwan">
            </path>
            <path class="allPaths"
            ...
            <path class="allPaths" d="M592.9 422l-0.5-0.2-0.5-0.5 0.1-0.6 0.2 0.3 0.4 0.4 0.3 0.5 0 0.1z"    id="Aruba">
            </path>
            <path class="allPaths" d="M634.2 384.9l-0.2 0 0.3-0.4 0.3 0-0.2 0.3-0.2 0.1z"    id="Anguilla">
            </path>
            ...
            <path class="allPaths" d="M635.2 387l-0.1-0.3 0.3 0.1-0.2 0.2z"    id="Saint-Barthélemy">
            </path>
            <path class="allPaths"
            ...
            <path class="allPaths"
                d="M651.5 418l-0.6-0.2-0.1-0.5 0-0.8 0.2-0.4 0.2 0.2 0.2 0.6 0.5 0.3 0.1 0.4-0.5 0.4z"    id="Barbados">
            </path>
            ...
            <path class="allPaths"
                d="M639.2 424.5l-0.4 0.3-0.2-0.1-0.1-0.5 0.2-0.5 0.3-0.4 0.3 0 0.1 0.3-0.1 0.7-0.1 0.2z"    id="Grenada">
            </path>
            <path class="allPaths"
            ...
            <path class="allPaths" d="M634.2 386l-0.4-0.1 0.2-0.3 0.3-0.1-0.1 0.5z"    id="Saint-Martin">
            </path>
            <path class="allPaths" d="M1402.9 474.8l0 0.2-0.2-0.1 0.2-0.2 0 0.1z"    id="Maldives">
            </path>
            <path class="allPaths" d="M1953.8 456l1 0.4-0.2 0-0.8-0.4z"    id="Marshall Islands">
            </path>
            ...
            <path class="allPaths" d="M638.2 393.9l0.2 0.4 0 0.3-0.2 0.2-0.2-0.1-0.1-0.3 0.3-0.5z"    id="Montserrat">
            </path>
            ...
            <path class="allPaths" d="M1933 505.3l-0.2 0-0.1-0.3 0.3 0 0 0.3z"    id="Nauru">
            </path>
            <path class="allPaths"
            ...
            <path class="allPaths" d="M634.2 386l0 0.1-0.4-0.1 0-0.1 0.4 0.1z"    id="Sint Maarten">
            </path>
            ...
            <path class="allPaths" d="M1998.9 556.6l0-0.2 0.1 0 0 0.1-0.1 0.1z"    id="Tuvalu">
            </path>
            <path class="allPaths"
                d="M642.2 417.4l-0.1 0.1-0.5-0.3 0-0.4 0.2-0.3 0.2-0.5 0.4 0 0.1 0.4-0.1 0.8-0.2 0.2z"   
                id="Saint Vincent and the Grenadines">
            </path>
            <path class="allPaths" d="M626.1 383.4l-0.4 0.2-0.1 0-0.3 0.2-0.1-0.1 0.1-0.3 0.6-0.1 0.2 0.1z"   
